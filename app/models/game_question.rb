...
class GameQuestion < ActiveRecord::Base
  ...
  # Автоматическая сериализация поля в базу (мы юзаем как обычный хэш, а рельсы в базе хранят как строчку)
  ...
  # Добавляем в help_hash по ключу fifty_fifty массив из двух вариантов: правильный и случайный и сохраняем объект
  def add_fifty_fifty
